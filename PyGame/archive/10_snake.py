    ...
    while True:
        ...
        for wormBody in wormCoords[1:]:
            ...
            if wormCoords[HEAD]["x"] == apple["x"] and wormCoords[HEAD]["y"] == apple["y"]:
                ...
                # move worm by adding a segment in the direction it is moving
                if direction == UP:
...
def drawPressKeyMsg():
    ...
    pressKeyRect.topleft = (WINDOWWIDTH - 200, WINDOWHEIGHT - 300)
...
def drawWorm(wormCoords):
    for coord in wormCoords:
        ...
        wormInnerSegmentRect = pygame.Rect(x + 4, y + 3, CELLSIZE - 8, CELLSIZE - 8)
