...
line_start = (SCREEN_HEIGHT/2, SCREEN_WIDTH/2)
...
while running:
    ...
    pygame.draw.line(screen, "#FFFFFF", line_start, pos, width=10) # this is just visual. Collision happens below
    # draw rect
    for i in obstacles:
        if i.clipline((line_start,pos)): # collision happens here
