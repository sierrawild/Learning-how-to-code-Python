...
def draw():
    ...
    # Fixed increment per frame (not dependent on actual framerate)
    theta += py5.TAU / (120 * period)  # Hard-code 120 instead of get_frame_rate()
...
# Variables
theta = 0
period = 3  # Period in seconds at 120fps = 360 frames per cycle
